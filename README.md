...
- **EXIF Caption section** (off by default)
  ...
  - Templates:
    ...
    - `{camera} • {lens}`
  - Font style (Clean/Mono), size, alignment, and bottom-center/bottom-right placement controls
  - Caption is rendered in the border below the photo by default
